...
public class CreateUMLModel {
	 ...
	 */
	public Property createProperty(org.eclipse.uml2.uml.Class _class, String name, Type type, int lowerBound, int upperBound,int low,int up) {
